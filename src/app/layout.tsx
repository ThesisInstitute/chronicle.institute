...
export const metadata: Metadata = {
  metadataBase: new URL("https://ledger.thesisinstitute.org"),
  title: {
    default: "Thesis Institute Ledger",
    template: "%s — Thesis Institute Ledger",
  },
  description:
  ...
  return (
    <html lang="en">
      <head>
        ...
        />
        <link
          href="https://fonts.googleapis.com/css2?family=IBM+Plex+Mono:wght@400;500&family=IBM+Plex+Sans:wght@300;400;500;600&family=Newsreader:ital,opsz,wght@0,6..72,300..600;1,6..72,300..600&display=swap"
          rel="stylesheet"
        />
      </head>
      <body>
        ...
        <header className="border-b border-border-soft bg-paper">
          <div className="mx-auto flex max-w-6xl flex-wrap items-baseline gap-x-8 gap-y-2 px-4 py-4 sm:px-6">
            <Link
              href="/"
              className="shrink-0 text-text-primary hover:no-underline"
            >
              <span
        ...
        <footer className="mt-16 border-t border-border-soft bg-paper">
          <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6">
            <p className="text-sm text-text-secondary">
              Unlisted preview. This deployment is not indexed and not linked
              from thesisinstitute.org.
            </p>
            ...
            <p className="mt-4 text-xs text-text-tertiary">
              <Link href="/about">About the Ledger</Link> ·{" "}
